...
create_yml () {
  ...
  (
    umask 077
    echo -e "host: $host\nport: $port\npassword: $password" > "/home/gsf29/host_jupyter/connection.yml"
  )
}
...
clean_up () {
  echo "Cleaning up..."
  [[ -e "/home/gsf29/host_jupyter/clean.sh" ]] && source "/home/gsf29/host_jupyter/clean.sh"
...
[[ -e "/home/gsf29/host_jupyter/before.sh" ]] && source "/home/gsf29/host_jupyter/before.sh"

echo "Script starting..."
"/home/gsf29/host_jupyter/script.sh" &
SCRIPT_PID=$!

[[ -e "/home/gsf29/host_jupyter/after.sh" ]] && source "/home/gsf29/host_jupyter/after.sh"
